package at.christianoezelt.test.cendecen.serialization
...
/**
  * should have achieved json serialization
  * doesn't work because it tries to cast case classes to Strings which obv. throws runtime errors
  *
  * TODO: implement generic json mapping ( case class -> json -> binary and binary -> json -> case class )
  *
  * @param system
  */
class JsonSerializer(val system: ExtendedActorSystem) extends EventStoreSerializer {
